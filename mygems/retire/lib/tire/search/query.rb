module Tire
  module Search
    ...
    class Query
      ...
      def match_phrase( value, field, options={} )
        @value = { :match_phrase_prefix => {field => { :query => value } } }
        @value.update( options )
        @value
      end

      def phrase( value, field, options={} )
        @value = { :text_phrase_prefix => {field => { :query => value } } }
        @value
      end
